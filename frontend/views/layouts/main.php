                    ...
                    <div class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo Yii::$app->urlManager->createUrl(['academics/index']); ?>">Departments</a></li>
                                    <li><a href="<?php echo Yii::$app->urlManager->createUrl(['academics/congresses']); ?>">Congresses</a></li>
                                    <li><a href="<?php echo Yii::$app->urlManager->createUrl(['academics/kcse']); ?>">Results</a></li>
                                    <li><a href="<?php echo Yii::$app->urlManager->createUrl(['academics/results']); ?>">KCSE</a></li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">STUDENTS<i class="fa fa-angle-down"></i></a>
                                <ul class="dropdown-menu">
                                    <li><a href="<?php echo Yii::$app->urlManager->createUrl(['students/index']); ?>">Student Cancil</a></li>
                                    <li><a href="<?php echo Yii::$app->urlManager->createUrl(['/alumini/index']); ?>">Alumini</a></li>
                                    <li><a href="<?php echo Yii::$app->urlManager->createUrl(['students/games']); ?>">Games</a></li>
                                    <li><a href="<?php echo Yii::$app->urlManager->createUrl(['students/admission']); ?>">Admission</a></li>
                                </ul>
                            </li>
                            <li><a href="<?php echo Yii::$app->urlManager->createUrl(['/site/contact']); ?>">CONTACT US</a></li>
                            <li><a href="<?php echo Yii::$app->urlManager->createUrl(['/site/downloads']); ?>">DOWNLOADS</a></li>
                        </ul>
                    </div>
                </div><!--/.container-->
            </nav><!--/nav-->
